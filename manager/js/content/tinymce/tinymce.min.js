    ...
    r(l, [], function () {
        ...
        function b(t, n) {
            var i = n.length > 0, o = t.length > 0, a = function (r, a, s, l, c) {
                var u, d, f, h = 0, p = "0", m = r && [], v = [], y = R, b = r || o && w.find.TAG("*", c), C = U += null == y ? 1 : Math.random() || .1, x = b.length;
        ...
        var C, x, w, N, E, _, S, k, R, T, A, B, D, L, M, P, H, O, I, F = "sizzle" + -new Date, z = window.document, U = 0, W = 0, V = n(), $ = n(), q = n(), j = function (e, t) {
            return e === t && (A = !0), 0
        ...
        var w = document, N = Array.prototype.push, E = Array.prototype.slice, _ = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, S = e.Event, k, R = r.makeMap("children,contents,next,prev"), T = r.makeMap("fillOpacity fontWeight lineHeight opacity orphans widows zIndex zoom", " "), A = r.makeMap("checked compact declare defer disabled ismap multiple nohref noshade nowrap readonly selected", " "), B = {
            "for": "htmlFor",
            "class": "className",
            readonly: "readOnly"
        ...
        return function (e) {
            ...
            function f(e) {
                var n, r, i, o, s, l, c, f, h, p, m, g, v, b, x, w, N, E, _, S = /^([#+\-])?([^\[!\/]+)(?:\/([^\[!]+))?(?:(!?)\[([^\]]+)\])?$/, k = /^([!\-])?(\w+::\w+|[^=:<]+)?(?:([=:<])(.*))?$/, R = /[*?+]/;
        ...
        function i(i, a) {
            ...
            i = i || {}, l.schema = a = a || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), o("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var l = this, c, u = 0, d, f, h = [], p, m, g, v, y, b, C, x, w, N, E, _, S, k, R, T, A, B, D, L, M, P, H, O, I, F = 0, z = t.decode, U, W = n.makeMap("src,href,data,background,formaction,poster"), V = /((java|vb)script|mhtml):/i, $ = /^data:/i;
        ...
        return function (i, a) {
            ...
            var N = a.dom, E = t.each, _, S, k, R, T, A, B, D, L, M, P, H, O, I, F, z, U = a.getDoc(), W = document, V = r.ie && r.ie < 11, $ = Math.abs, q = Math.round, j = a.getBody(), Y, X;
        ...
        return function (n) {
            ...
            n.on("PreInit", function () {
                ...
                "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull": function (e) {
                    var t = "align" + e.substring(7), n = T.isCollapsed() ? [R.getParent(T.getNode(), R.isBlock)] : T.getSelectedBlocks(), r = l(n, function (e) {
        ...
        function y(c) {
            ...
            function Y() {
                ...
                var g = b(I, 1, ne, E), v = b(I, -1, re, N), w = b(j, 1, E, N), _ = b(j, -1, N, E), R = b(F, -1, a.upUntil), B = b(F, 1, a.downUntil);
        ...
        return e.extend({
            recalc: function (e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v = [], y, b, C, x, w, N, E, _, S, k, R, T, A, B, D, L, M, P, H, O, I, F, z = Math.max, U = Math.min;
        ...
        return e.extend({
            recalc: function (e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v, y, b, C, x, w, N, E = [], _ = [], S, k, R, T, A, B;
