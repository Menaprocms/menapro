tinymce.PluginManager.add('image', function(editor) {
    ...
    function showDialog(imageList) {
       ...
       // console.log('open my filemanager');
        $('#myfilemanager-action').banana(JSBlocks.getFileBananaSettings('myfilemanager-inp'));
        $('#mce-modal-block').css('z-index','900');
    }
 ...
 * Created by silvia on 19/07/2016.
 */
