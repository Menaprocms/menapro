...
$arr=explode('/',Yii::getAlias('@web'));
$index=sizeof($arr)-1;
unset($arr[$index]);
$new_url=implode('/',$arr);

define('NEW_URL',$new_url);
...
| <input type="button" href="../filemanager/filemanager/dialog?field_id=imgField&lang=en_EN&akey=myPrivateKey" value="Files">
...
$config = array(
	...
	*/
	...
	'upload_dir' =>Yii::getAlias('@menaBasePublic').'/upload/',
